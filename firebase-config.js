...
const SCHOOLS = {
  bristol: {
    ...
    nameAr: "مدارس بريستول للغات",
    directorate: "إدارة دمياط الجديدة التعليمية",
    receiptLogo: "bristol-receipt-logo.jpeg",
    primaryColor: "#1e2d5a",
